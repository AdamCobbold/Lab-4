...
def print_menu(exits):
    ...
    for ways_out in exits:
        print_menu_line(ways_out, rooms[exits[ways_out]]["name"])
...
def menu(exits):
    ...
    while True:
        ...
        norm_command = normalise_input(player_command)
        if is_valid_exit(exits, norm_command) == True:
            return norm_command
